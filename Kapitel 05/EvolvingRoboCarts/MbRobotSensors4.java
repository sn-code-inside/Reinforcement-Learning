...
/**
 * Definition of the MbRobotSensors with 4 distance sensors.
 * 
 ...
 */
public class MbRobotSensors4 extends MbRobotSensors
{   
    public MbRobotSensors4()
    {
        super();
        produceSensors();
    }
    ...
    { 
        sensornames = new String[]{"left side distance sensor","left front distance sensor","right front distance sensor side","right side distance sensor"};
        ...
        sp_dist_points[0] = new IntegerVec2D(14,3); 
        sp_dist_points[1] = new IntegerVec2D(14,-3); 
        sp_dist_points[2] = new IntegerVec2D(9,8); 
        sp_dist_points[3] = new IntegerVec2D(9,-8);
        dist_sensors_direction = new int[][]{{ range_distance_sensor, 0},  // { sensor dir_x, dir_y},
                                             { range_distance_sensor, 0},
                                             { round(range_distance_sensor/1.41), round(range_distance_sensor/1.41)},
                                             { round(range_distance_sensor/1.41),-round(range_distance_sensor/1.41)}};
    }
