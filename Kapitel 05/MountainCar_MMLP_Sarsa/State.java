...
public class State  
{
    public final static int DIM = 2; // dimension of the state space
    public final static int PARTS = 8;
    public static int FEATURE_TYPE = 1; // 0 - binary features; 1 - displaced binary features; 2 - RBF-features; 3 - (normalized) sensor input
    ...
    public State(double[] s_werte)
    {
        ...
        normVec = calcNormvec();
        switch (FEATURE_TYPE){
            case 0: x_vektor = calcBinaryFeatureVec();
                    break;
            case 1: x_vektor = calcDispBinaryFeatureVec();
                    break; 
            case 2: x_vektor = calcRbfFeaturevec();
                    break;
            case 3: x_vektor = normVec;
                    break;
        }
    }
    ...
    public static int getVectorSize(){
        switch (FEATURE_TYPE){
            case 0: return DIM*PARTS;
            case 1: return 3*DIM*PARTS;
            case 2: return DIM*PARTS;
            case 3: return DIM;
        }
        return -1;
    }
    ...
    private double[] calcRbfFeaturevec(){
        double[] x_vec = new double[getVectorSize()];
