...
public class Hamster extends Actor {
    ...
    public boolean isFrontFree() {
        ...
        return ((RL_GridEnv)getWorld()).isStatePossible(x,y); // faster
    }
    ...
    public void setLocation(int x, int y) {
       ...
       if (((RL_GridEnv)getWorld()).isStatePossible(x,y))  // Much faster, because it uses the arena string-array. (mod. by Lorenz 06/2021)
       {
